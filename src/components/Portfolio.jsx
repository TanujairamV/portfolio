    ...
    <div className="min-h-screen bg-background text-text-primary">
      ...
      <div
        className={`fixed top-0 left-0 pointer-events-none z-[9999] rounded-full transition-all duration-100 ease-out ${
          isCursorHovering ? 'w-14 h-14 border-2 border-accent-purple' : 'w-10 h-10 border border-[rgba(255,255,255,0.2)]'
        }`}
        style={{
          transform: `translate(${cursorPosition.x - (isCursorHovering ? 28 : 20)}px, ${cursorPosition.y - (isCursorHovering ? 28 : 20)}px)`,
